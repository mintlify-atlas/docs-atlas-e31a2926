---
title: "Get Started with Supercharged Citation Picker"
sidebarTitle: "Quickstart"
description: "Learn how to trigger the citation picker, search your BibTeX library, and insert your first Pandoc or LaTeX citation in under a minute."
---
...
<Tabs>
  ...
  <Tab title="LaTeX">
    ...
    ```
    Uses `\autocite` from BibLaTeX. Multi-citation and page-number support follows LaTeX conventions.
  </Tab>
  <Tab title="Org mode">
    ```
    [cite:@Grieser2020]
