---
title: "Troubleshooting the Supercharged Citation Picker"
...
The **Reveal in app** action (<kbd>⇧↵</kbd>) — which opens the entry in Zotero, BibDesk, Neovim, VS Code, or Sublime Text depending on your `open_entries_in` setting — is currently only implemented for the **primary** library.
