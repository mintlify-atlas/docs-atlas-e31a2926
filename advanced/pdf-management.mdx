---
title: "Auto-File and Open PDFs by Citekey"
sidebarTitle: "PDF Management"
description: "Automatically rename and file PDFs using the BibTeX citekey, open PDFs from Alfred, and filter entries that have associated PDF files."
---
...
4. Constructs the destination path: `{pdf_folder}/{FirstLetter}/{Author}/{citekey}_{title}.pdf`
