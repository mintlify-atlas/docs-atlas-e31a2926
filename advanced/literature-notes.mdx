...
description: "Automatically create Markdown literature notes named by citekey, open them in Obsidian or your default editor, and filter entries that already have notes."
---
...
Vault detection uses a case-insensitive path prefix match, so it works correctly regardless of how macOS capitalizes directory names.
