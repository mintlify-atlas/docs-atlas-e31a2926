---
title: "Search and Install CSL Citation Styles for Pandoc Output"
sidebarTitle: "CSL Styles"
description: "Search the official CSL styles repository, download any .csl file to your local folder, and apply it for formatted bibliography output via Pandoc."
---
...
When you open the CSL search, the workflow fetches the complete list of `.csl` files from the GitHub API for the [`citation-style-language/styles`](https://github.com/citation-style-language/styles) repository:
...
The file is saved to the folder specified by the `csl_folder` workflow variable.
...
This style is then used by both the [Paste Full Bibliography](/advanced/bibliography-actions#paste-full-bibliography) and [Paste Formatted Single Entry](/advanced/bibliography-actions#paste-formatted-single-entry) features.
